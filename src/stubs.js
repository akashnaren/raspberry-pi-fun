...
const NOTES = {
  nova: "Over budget. Tomorrow: smallest change that still converts a time.",
  kessler: "Over budget. Recheck empty-city and unknown-city before the next green.",
  mira: "Over budget. Do not add a city form while the studio sleeps.",
